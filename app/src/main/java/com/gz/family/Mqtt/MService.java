...
public class MService extends Service implements MqttCallback {
    ...
    private MsgFiller msgFiller = new MsgFiller();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (code) {
            ...
            default:
                ...
                mqttHelper = new MqttHelper(getApplicationContext(), UserStore.getLocalUser(true).getId());
                mqttHelper.connect(new MqttHelper.ActionListener() {
                    ...
                    public void success() {
                        ...
                        mqttHelper.subscribe(UserStore.getLocalUser(true).getId(),2);
                    }
...
//            lastHeatBeatTime = System.currentTimeMillis();
    ...
    ***********implement method****************
    ...
    public void connectionLost(Throwable throwable) {
        ...
        if (((MqttException)throwable).getReasonCode()==6) {
            mqttHelper.cleanConnect();
        }
        setOverTime();
    }
